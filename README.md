...
|Stick-hero-activity| <ul><li>Fixed arrow key not working </li><ul> | [Link to work](https://github.com/sugarlabs/stick-hero-activity/pull/39) </br> [Link to release](https://github.com/sugarlabs/stick-hero-activity/pull/40) | Merged </br> Under Review |
